...
var _injecter = __webpack_require__(1);

var _RequestsManager = __webpack_require__(2);

var _RequestsManager2 = _interopRequireDefault(_RequestsManager);

var _PrettyDifferences = __webpack_require__(7);

var _PrettyDifferences2 = _interopRequireDefault(_PrettyDifferences);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _injecter.applyXHRPatch)();

var requestsManager = new _RequestsManager2.default(document);
requestsManager.onLog(function (data) {
    ...
    _PrettyDifferences2.default.consoleLog(data.differences);
});
...
exports.applyXHRPatch = applyXHRPatch;
function applyXHRPatch() {
...
var _RequestsStorage = __webpack_require__(3);

var _RequestsStorage2 = _interopRequireDefault(_RequestsStorage);
...
var RequestsManager = function () {
    function RequestsManager(document) {
        _classCallCheck(this, RequestsManager);

        this.logCallback = function () {};

        this._requestsStorage = new _RequestsStorage2.default();
    ...
    _createClass(RequestsManager, [{
        ...
        value: function _processRequest(request) {
            if (request.method == "GET") {
                ...
                var GETRequest = this._requestsStorage.findRelated(request);
                if (GETRequest !== null) {
        ...
        key: '_diffRequests',
        value: function _diffRequests(GETRequest, POSTRequest) {
            var differences = (0, _deepDiff.diff)(GETRequest.responseBody, POSTRequest.responseBody);
            var logResult = {
...
exports.default = RequestsManager;
...
var RequestsStorage = function () {
    function RequestsStorage() {
        _classCallCheck(this, RequestsStorage);

        this._storage = [];
    }

    _createClass(RequestsStorage, [{
        key: "pushGETRequest",
        value: function pushGETRequest(GETRequest) {
        ...
        key: "findRelated",
        value: function findRelated(POSTRequest) {
        ...
        key: "_parseResponseBody",
        value: function _parseResponseBody(responseBody) {
            ...
            try {
                ...
                if (typeof responseObject === null || (typeof responseObject === "undefined" ? "undefined" : _typeof(responseObject)) !== "object") {
                    responseObject = null;
                }
            } catch (e) {
                responseObject = null;
...
exports.default = RequestsStorage;
...
var PrettyDifferences = function () {
    function PrettyDifferences() {
        _classCallCheck(this, PrettyDifferences);
    }

    _createClass(PrettyDifferences, null, [{
        key: "consoleLog",
        value: function consoleLog(differences) {
            var changedColor = "#fcd203";
            var newColor = "#80f92a";
    ...
    return PrettyDifferences;
}();

exports.default = PrettyDifferences;
